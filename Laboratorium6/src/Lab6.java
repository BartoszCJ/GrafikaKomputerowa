...
public class Lab6 extends GLJPanel implements GLEventListener  {
    ...
    public void display(GLAutoDrawable drawable) {
        ...
        int katy = 13; //trzynastokat
        double funkcja = 2 * Math.PI/katy;
        double kat =0;
        int przekatna =5;
        float x =0;
        float z = 0;
        ...
        for (int i = 1; i <= katy; i++) {
            ...
            x = (float) (przekatna * Math.cos(kat));
            z = (float) (przekatna * Math.sin(kat));
            kat = i * funkcja;
            float x0 = (float) (przekatna * Math.cos(kat));
            float z0 =(float) (przekatna * Math.sin(kat));
